...
# Kursen mvc organisation
	...
	@dir="2025/mvc/teacher"; \
	repo="git@github.com:bth-mvc/teacher.git"; \
	[ -d $$dir ] || git clone $$repo $$dir;
	...
	@dir="2025/mvc/api-server"; \
	repo="git@github.com:bth-mvc/api-server.git"; \
	[ -d $$dir ] || git clone $$repo $$dir;
...
# Kursen databas organisation
	...
	repo="git@github.com:bth-databas/website.git"; \
	[ -d $$dir ] || git clone $$repo $$dir;

	@dir="2025/databas/forum"; \
	repo="git@github.com:bth-databas/forum.git"; \
	[ -d $$dir ] || git clone $$repo $$dir;
